            ...
            case 2:
                ...
                if suit1 == self.Trump and suit2 == self.Trump:
                    ...
                    if len(__temp_list_Trumps) > 0:
                        ...
                        __temp_list_other3 = {}
                        __suits_in_Hand = [x for x in ['Spade', 'Club', 'Diamond', 'Heart'] if x != self.Trump]
                        for card in self.Hand:
                            if card[0:-2] == __suits_in_Hand[0]:
                                __suit_other1 +=1
                                __suit_other1_value += self.Hand[card]
                                ...
                                __temp_list_other3.update({card: self.Hand[card]})
                        if __weight_other1 >= __weight_other2:
                            card = min(__temp_list_other1, key=__temp_list_other1.get)
                            card_to_send = {card: self.Hand[card]}                           
                            self.Hand.pop(card)
                            ...
                            card = min(__temp_list_other3, key=__temp_list_other3.get)
                            card_to_send = {card: self.Hand[card]}                           
                            self.Hand.pop(card)
                            return card_to_send              
                    ...
                    __suit_other2_value = 0
                    __temp_list_other2 = {}
                    __suits_in_Hand = [x for x in ['Spade', 'Club', 'Diamond', 'Heart'] if x not in [suit1, self.Trump]]
                    for card in self.Hand:
                        if card[0:-2] == __suits_in_Hand[0]:
                                __suit_other1 +=1
                                __suit_other1_value += self.Hand[card]
